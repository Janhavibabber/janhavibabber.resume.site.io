...
$(".project-0").hover(function(){
  $(".cursor").css({"background-image": "url('IMG/p1.jpg')"});
});

$(".project-1").hover(function(){
  $(".cursor").css({"background-image": "url('IMG/p2.jpg')"});
});

$(".project-2").hover(function(){
  $(".cursor").css({"background-image": "url('IMG/p3.jpg')"});
});

$(".project-3").hover(function(){
  $(".cursor").css({"background-image": "url('IMG/p4.jpg')"});
});
